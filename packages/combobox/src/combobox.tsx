  ...
  return (
    ...
    >
      <div className='relative flex flex-col space-y-2'>
        ...
        <div
          className={cn(
            'relative w-full py-1 pl-3 pr-10 transition-shadow border rounded-md cursor-default text-primary border-secondary-light focus-within:shadow-sm focus-within:border-primary focus-within:ring-1 focus-within:ring-primary hover:shadow-sm focus-within:outline-none',
      ...
      <Transition
        ...
        afterLeave={() => setQuery('')}
      >
        <HUICombobox.Options className='w-full py-1 mt-1 overflow-auto text-xs bg-white rounded-md shadow-sm max-h-60 focus:outline-none sm:text-sm'>
